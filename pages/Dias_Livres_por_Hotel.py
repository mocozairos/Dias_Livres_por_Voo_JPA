...
def puxar_dados_phoenix():
    ...
    st.session_state.df_router = st.session_state.df_router[(st.session_state.df_router['Servico'] != 'FAZER CONTATO - SEM TRF IN ') & (st.session_state.df_router['Servico'] != 'GUIA BASE NOTURNO') & 
                                                            (st.session_state.df_router['Servico'] != 'GUIA BASE DIURNO ') & (st.session_state.df_router['Status do Servico']!='CANCELADO') & 
    ...
    st.session_state.df_router = st.session_state.df_router[~st.session_state.df_router['Servico'].isin(lista_combos)].reset_index(drop=True)
